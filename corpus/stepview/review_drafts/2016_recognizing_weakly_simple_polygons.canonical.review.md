...
![Figure 3 Two perturbations of a weakly simple polygon on 6 vertices (all of them spurs) that alternate between two distinct points in the plane.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-3-p004.png)
...
![Figure 4 A crimp reduction replaces [ a, b, c, d ] with [ a, d ]. Top](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-4-p004.png)
...
![Figure 5 Node expansion. (Left) Changes in the image graph. (Right) Changes in P (the vertices are perturbed for clarity); new nodes are shown as squares.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-5-p005.png)
...
![Figure 6 The old-bar-expansion converts a non-weakly simple polygon to a weakly simple one.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-6-p005.png)
...
Chang et al. [4][Section 4] define a bar expansion operation, referred in this paper as old-barexpansion. For a bar \(b\) of the image graph, draw a long and narrow ellipse \(D_{b}\) around the interior nodes of \(b\), and replace each maximal path that intersects with \(D_{b}\) by a straight-line edge. If \(b\) contains no spurs, old-bar-expansion is known to be ws-equivalent [4]. Otherwise, it can produce false positives, hence it is not ws-equivalent; see Fig. 6 for an example.
...
![Figure 7 The changes in the image graph caused by new-bar-expansion .](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-7-p006.png)
...
![Figure 8 Formation of new clusters around (left) a sober node and (right) a node on the boundary of an elliptical disk. The roots of the induced trees are colored blue.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-8-p006.png)
...
![Figure 9 The changes in the image graph caused by a bar simpliﬁcation.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-9-p007.png)
...
![Figure 10 The changes in the polygon caused by a bar simpliﬁcation.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-10-p008.png)
...
![Figure 11 Left](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-11-p008.png)
...
![Figure 13 V-shortcut . Changes in the image graph (top), changes in the polygon (bottom).](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-13-p009.png)
...
![Figure 14 L-shortcut . Changes in the image graph (top), changes in the polygon (bottom).](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-14-p010.png)
...
![Figure 16 Life cycle of a cross chain in the while loop of bar-simpliﬁcation . The steps applied, from left to right, are](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-16-p011.png)
...
![Figure 15 If P 1 is weakly simple, we can change the linear order of the edges as shown.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-15-p011.png)
...
Since \(\mathcal{P} i_{n}=\emptyset\), condition (B1) is met. Suppose there is an edge \(\left[p, u_{1}\right]\) such that segment \(p u_{1}\) is in the interior of the wedge \(\angle\left(v, u_{1}, u_{\text {min }}\right)\). Clearly, \(p \in \partial D_{b}\) is a top node. Then edge \(\left[p, u_{1}\right]\) is part of a path \(\left[p, u_{1}, q\right]\). However, \(q\) must be in the closed wedge \(\angle\left(v, u_{1}, u_{\text {min }}\right)\) otherwise there would be a node-crossing at \(u_{1}\). Also, \(q\) cannot be a top vertex on \(\partial D_{b}\) since \(\mathcal{P}\) in \(=\mathcal{V}=\emptyset\), and \(q\) cannot be on \(b\) by the choice of node \(v\). This confirms
...
![Figure 18 Splitting group G uv . (a) Changes in the image graph. (b) Changes in the polygon.](/Users/evanthayer/Projects/paperx/docs/2016_recognizing_weakly_simple_polygons/figures/figure-18-p015.png)
...
- 1 Hugo A. Akitaya, Greg Aloupis, Jeff Erickson, and Csaba D. Tóth. Recognizing weakly simple polygons. Preprint, 2016. arXiv:1603.07401.
