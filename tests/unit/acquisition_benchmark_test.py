...
class AcquisitionBenchmarkTest(unittest.TestCase):
    def test_load_benchmark_manifest_resolves_provider_paths(self) -> None:
        ...
        self.assertEqual({paper.paper_id for paper in papers}, {"fixture_paper", "math_dense_fixture"})
        self.assertEqual({paper.family for paper in papers}, {"born_digital_scholarly", "math_dense"})
        for paper in papers:
    ...
    def test_benchmark_scores_docling_above_mathpix_for_fixture(self) -> None:
        ...
        self.assertEqual({entry["family"] for entry in report["families"]}, {"born_digital_scholarly", "math_dense"})
    ...
    def test_benchmark_cli_prints_json_report(self) -> None:
        ...
        self.assertEqual({paper["paper_id"] for paper in payload["papers"]}, {"fixture_paper", "math_dense_fixture"})
