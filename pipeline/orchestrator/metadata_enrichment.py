...
def apply_metadata_observation(state: Any) -> Any:
    ...
    if observed_title and (not current_title or len(current_title.split()) < 3):
    ...
    if abstract_block is not None and observed_abstract and current_abstract_flags and not observed_abstract_flags:
