...
from pipeline.corpus_layout import ProjectLayout, canonical_path, current_layout, review_draft_path
...
def write_review_from_canonical(
    paper_id: str,
    *,
    layout: ProjectLayout | None = None,
) -> Path:
    active_layout = layout or current_layout()
    document = json.loads(canonical_path(paper_id, layout=active_layout).read_text(encoding="utf-8"))
    destination = review_draft_path(paper_id, layout=active_layout)
