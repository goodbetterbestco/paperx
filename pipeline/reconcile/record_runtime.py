...
class ReconcileRecordRuntimeHelpers:
    build_blocks_for_record: object
    merge_layout_and_figure_records: object
    mark_records_with_external_math_overlap: object
    repair_record_text_with_mathpix_hints: object
    promote_heading_like_records: object
    merge_code_records: object
    merge_paragraph_records: object
    suppress_graphic_display_math_blocks: object
    suppress_running_header_blocks: object
    normalize_footnote_blocks: object
    merge_paragraph_blocks: object
...
def build_reconcile_record_runtime_helpers(
    *,
    ...
    text_helpers: object,
    math_helpers: object,
) -> ReconcileRecordRuntimeHelpers:
    return ReconcileRecordRuntimeHelpers(
