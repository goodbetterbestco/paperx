...
from pipeline.assembly.section_support import section_id
...
def build_reconcile_source_resolution_deps(
    *,
    runtime_layout: Any,
    loaders: Any,
...
def build_reconcile_paper_pipeline_deps(
    *,
    runtime_layout: Any,
    loaders: Any,
    bindings: Any,
    ...
    source_resolution_deps = build_reconcile_source_resolution_deps(
        runtime_layout=runtime_layout,
        loaders=loaders,
        normalize_figure_caption_text=text_helpers.normalize_figure_caption_text,
    )
    return PaperPipelineDeps(
        source_resolution=source_resolution_deps,
        record_normalization=PaperRecordNormalizationDeps(
            ...
            extract_pdftotext_pages=make_layout_bound_loader(
                loader=loaders.extract_pdftotext_pages,
