...
def compose_external_sources(
    ...
    *,
    ...
    load_grobid_metadata_observation_impl = load_grobid_metadata_observation_impl or load_grobid_metadata_observation
...
def existing_composed_sources(
    ...
    *,
    ...
    ocr_prepass_report_path_impl = ocr_prepass_report_path_impl or ocr_prepass_report_path
    acquisition_execution_report_path_impl = acquisition_execution_report_path_impl or acquisition_execution_report_path
    load_docling_metadata_observation_impl = load_docling_metadata_observation_impl or load_docling_metadata_observation
    load_grobid_metadata_observation_impl = load_grobid_metadata_observation_impl or load_grobid_metadata_observation
    load_mathpix_metadata_observation_impl = load_mathpix_metadata_observation_impl or load_mathpix_metadata_observation
    external_layout = load_json_if_exists_impl(external_layout_path_impl(paper_id, layout=layout)) or {"engine": "none", "blocks": []}
    math = load_json_if_exists_impl(external_math_path_impl(paper_id, layout=layout)) or {"engine": "none", "entries": []}
    sources_dir = external_layout_path_impl(paper_id, layout=layout).parent
    ...
    acquisition_execution = load_json_if_exists_impl(acquisition_execution_report_path_impl(paper_id, layout=layout)) or {}
    metadata_candidates = {
    ...
    return {
        ...
        "layout_engine": reported_layout_provider(str(external_layout.get("engine", "") or "") or None, source_scorecard=source_scorecard, fallback="none"),
        "layout_blocks": len(external_layout.get("blocks", [])),
        "math_engine": reported_math_provider(str(math.get("engine", "") or "") or None, source_scorecard=source_scorecard, math_payload=math, fallback="none"),
        "math_entries": len(math.get("entries", [])),
        "acquisition_route": acquisition_route.get("primary_route"),
