...
- `python3 -m pipeline.cli.run_acquisition_remediation_wave recovery-critical-mathpix-1`
...
`--min-priority`. Remediation runs are now persisted under
...
as a compact operator status view. `pipeline.cli.list_acquisition_remediation_history`,
