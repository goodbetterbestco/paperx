...
from pipeline.reconcile.block_builder_binding_runtime import (
    ...
    make_match_external_math_entry as reconcile_make_match_external_math_entry_binding_runtime,
    rect_area as reconcile_rect_area_binding_runtime,
...
from pipeline.reconcile.section_filter_binding_runtime import (
    is_paragraph_like_record as reconcile_is_paragraph_like_record_runtime,
    looks_like_same_page_column_continuation as reconcile_looks_like_same_page_column_continuation_runtime,
    make_ends_like_clause_lead_in as reconcile_make_ends_like_clause_lead_in_binding_runtime,
    make_ends_like_short_lead_in as reconcile_make_ends_like_short_lead_in_binding_runtime,
    make_looks_like_running_header_record as reconcile_make_looks_like_running_header_record_binding_runtime,
    make_looks_like_table_body_debris as reconcile_make_looks_like_table_body_debris_binding_runtime,
    make_merge_anchor_spans as reconcile_make_merge_anchor_spans_binding_runtime,
    make_should_merge_paragraph_records as reconcile_make_should_merge_paragraph_records_binding_runtime,
    make_starts_like_paragraph_continuation as reconcile_make_starts_like_paragraph_continuation_binding_runtime,
    make_starts_like_strong_paragraph_continuation as reconcile_make_starts_like_strong_paragraph_continuation_binding_runtime,
    make_suppress_embedded_table_headings as reconcile_make_suppress_embedded_table_headings_binding_runtime,
)
...
from pipeline.reconcile.reference_binding_runtime import (
    make_extract_reference_records_from_tail_section as reconcile_make_extract_reference_records_from_tail_section_binding_runtime,
    make_is_reference_start as reconcile_make_is_reference_start_binding_runtime,
    make_looks_like_reference_text as reconcile_make_looks_like_reference_text_binding_runtime,
    make_merge_reference_records as reconcile_make_merge_reference_records_binding_runtime,
    make_reference_entry as reconcile_make_reference_entry_binding_runtime,
    make_reference_records_from_mathpix_layout as reconcile_make_reference_records_from_mathpix_layout_binding_runtime,
    make_split_trailing_reference_records as reconcile_make_split_trailing_reference_records_binding_runtime,
)
...
from pipeline.reconcile.support_binding_runtime import (
    ...
    make_normalize_paragraph_text as reconcile_make_normalize_paragraph_text_binding_runtime,
    ...
    page_height_map as reconcile_page_height_map_binding_runtime,
)
from pipeline.reconcile.screening_runtime import (
    make_is_figure_debris as reconcile_make_is_figure_debris_runtime,
    make_is_short_ocr_fragment as reconcile_make_is_short_ocr_fragment_runtime,
    make_looks_like_browser_ui_scrap as reconcile_make_looks_like_browser_ui_scrap_runtime,
    make_looks_like_glyph_noise_cloud as reconcile_make_looks_like_glyph_noise_cloud_runtime,
    make_looks_like_quoted_identifier_fragment as reconcile_make_looks_like_quoted_identifier_fragment_runtime,
    make_looks_like_table_marker_cloud as reconcile_make_looks_like_table_marker_cloud_runtime,
    make_looks_like_vertical_label_cloud as reconcile_make_looks_like_vertical_label_cloud_runtime,
)
from pipeline.reconcile.runtime_deps import (
    make_reconcile_assembly_deps as reconcile_make_reconcile_assembly_deps_runtime,
    make_reconcile_binding_block_builder_deps as reconcile_make_reconcile_binding_block_builder_deps_runtime,
    make_reconcile_binding_deps as reconcile_make_reconcile_binding_deps_runtime,
    make_reconcile_binding_front_matter_deps as reconcile_make_reconcile_binding_front_matter_deps_runtime,
    make_reconcile_binding_layout_heading_deps as reconcile_make_reconcile_binding_layout_heading_deps_runtime,
    make_reconcile_binding_math_deps as reconcile_make_reconcile_binding_math_deps_runtime,
    make_reconcile_binding_text_deps as reconcile_make_reconcile_binding_text_deps_runtime,
    make_reconcile_loader_deps as reconcile_make_reconcile_loader_deps_runtime,
    make_reconcile_runtime_deps as reconcile_make_reconcile_runtime_deps_runtime,
)
...
from pipeline.reconcile.text_repairs_runtime import (
    inline_tex_signal_count as reconcile_inline_tex_signal_count_runtime,
    make_is_mathpix_text_hint_better as reconcile_make_is_mathpix_text_hint_better_runtime,
    make_looks_like_truncated_prose_lead as reconcile_make_looks_like_truncated_prose_lead_runtime,
    make_matching_mathpix_text_blocks as reconcile_make_matching_mathpix_text_blocks_runtime,
    make_mathpix_hint_alignment_text as reconcile_make_mathpix_hint_alignment_text_runtime,
    make_mathpix_hint_tokens as reconcile_make_mathpix_hint_tokens_runtime,
    make_mathpix_prose_lead_repair_candidate as reconcile_make_mathpix_prose_lead_repair_candidate_runtime,
    make_mathpix_text_candidate_score as reconcile_make_mathpix_text_candidate_score_runtime,
    make_mathpix_text_hint_candidate as reconcile_make_mathpix_text_hint_candidate_runtime,
    make_record_union_bbox as reconcile_make_record_union_bbox_runtime,
    make_repair_record_text_with_pdftotext as reconcile_make_repair_record_text_with_pdftotext_runtime,
    make_should_skip_pdftotext_repair as reconcile_make_should_skip_pdftotext_repair_runtime,
    mathpix_text_blocks_by_page as reconcile_mathpix_text_blocks_by_page_runtime,
    token_subsequence_index as reconcile_token_subsequence_index_runtime,
)
...
from pipeline.reconcile.math_entry_binding_runtime import (
    ...
    make_math_entry_looks_like_prose as reconcile_make_math_entry_looks_like_prose_binding_runtime,
    make_paragraph_block_from_graphic_math_entry as reconcile_make_paragraph_block_from_graphic_math_entry_binding_runtime,
    make_should_demote_graphic_math_entry_to_paragraph as reconcile_make_should_demote_graphic_math_entry_to_paragraph_binding_runtime,
    make_should_demote_prose_math_entry_to_paragraph as reconcile_make_should_demote_prose_math_entry_to_paragraph_binding_runtime,
    make_should_drop_display_math_artifact as reconcile_make_should_drop_display_math_artifact_binding_runtime,
...
from pipeline.reconcile.front_matter_parsing_runtime import (
    looks_like_affiliation as reconcile_looks_like_affiliation_runtime,
    make_abstract_text_is_usable as reconcile_make_abstract_text_is_usable_runtime,
    make_build_affiliations_for_authors as reconcile_make_build_affiliations_for_authors_binding_runtime,
    make_dedupe_authors as reconcile_make_dedupe_authors_binding_runtime,
    make_filter_front_matter_authors as reconcile_make_filter_front_matter_authors_binding_runtime,
    make_is_title_page_metadata_record as reconcile_make_is_title_page_metadata_record_runtime,
    make_looks_like_affiliation_continuation as reconcile_make_looks_like_affiliation_continuation_runtime,
    make_looks_like_author_line as reconcile_make_looks_like_author_line_runtime,
    make_looks_like_body_section_marker as reconcile_make_looks_like_body_section_marker_runtime,
    make_looks_like_contact_name as reconcile_make_looks_like_contact_name_runtime,
    make_looks_like_front_matter_metadata as reconcile_make_looks_like_front_matter_metadata_runtime,
    make_looks_like_intro_marker as reconcile_make_looks_like_intro_marker_runtime,
    make_looks_like_page_one_front_matter_tail as reconcile_make_looks_like_page_one_front_matter_tail_runtime,
    make_normalize_abstract_candidate_text as reconcile_make_normalize_abstract_candidate_text_runtime,
    make_normalize_affiliation_line as reconcile_make_normalize_affiliation_line_runtime,
    make_normalize_author_line as reconcile_make_normalize_author_line_runtime,
    make_parse_authors as reconcile_make_parse_authors_runtime,
    make_parse_authors_from_citation_line as reconcile_make_parse_authors_from_citation_line_runtime,
    make_split_affiliation_fields as reconcile_make_split_affiliation_fields_runtime,
    make_split_leading_front_matter_records as reconcile_make_split_leading_front_matter_records_runtime,
    make_strip_author_prefix_from_affiliation_line as reconcile_make_strip_author_prefix_from_affiliation_line_runtime,
    make_strip_trailing_abstract_boilerplate as reconcile_make_strip_trailing_abstract_boilerplate_runtime,
)
...
_now_iso = reconcile_now_iso_binding_runtime

_clean_text = reconcile_make_clean_text_binding_runtime(
    control_char_re=CONTROL_CHAR_RE,
    compact_text=compact_text,
)

_strip_known_running_header_text = reconcile_make_strip_known_running_header_text_binding_runtime(
    procedia_running_header_re=PROCEDIA_RUNNING_HEADER_RE,
    clean_text=_clean_text,
)

_block_source_spans = reconcile_block_source_spans_binding_runtime

_clean_record = reconcile_make_clean_record_binding_runtime(
    strip_known_running_header_text=_strip_known_running_header_text,
)

_normalize_paragraph_text = reconcile_make_normalize_paragraph_text_binding_runtime(
    strip_known_running_header_text=_strip_known_running_header_text,
...
_normalize_formula_display_text = reconcile_make_normalize_formula_display_text_binding_runtime(
    clean_text=_clean_text,
    decode_ocr_codepoint_tokens=decode_ocr_codepoint_tokens,
)

_normalize_figure_caption_text = reconcile_make_normalize_figure_caption_text_binding_runtime(
    clean_text=_clean_text,
    normalize_prose_text=normalize_prose_text,
)

_record_analysis_text = reconcile_make_record_analysis_text_binding_runtime(
    clean_text=_clean_text,
)

_word_count = reconcile_make_word_count_binding_runtime(
    short_word_re=SHORT_WORD_RE,
)

_page_height_map = reconcile_page_height_map_binding_runtime

_is_pdftotext_candidate_better = reconcile_make_is_pdftotext_candidate_better_binding_runtime(
    clean_text=_clean_text,
    word_count=_word_count,
)


_should_skip_pdftotext_repair = reconcile_make_should_skip_pdftotext_repair_runtime(
    clean_text=_clean_text,
    word_count=_word_count,
    inline_math_re=INLINE_MATH_RE,
)

_repair_record_text_with_pdftotext = reconcile_make_repair_record_text_with_pdftotext_runtime(
...
_mathpix_text_blocks_by_page = reconcile_mathpix_text_blocks_by_page_runtime

_record_union_bbox = reconcile_make_record_union_bbox_runtime(
    block_source_spans=_block_source_spans,
)

_inline_tex_signal_count = reconcile_inline_tex_signal_count_runtime

_token_subsequence_index = reconcile_token_subsequence_index_runtime


_layout_record = reconcile_make_layout_record_runtime(
    clean_text=_clean_text,
)

_figure_label_token = reconcile_figure_label_token_runtime

_synthetic_caption_record = reconcile_synthetic_caption_record_runtime

_record_bbox = reconcile_make_record_bbox_runtime(
    block_source_spans=_block_source_spans,
)

_rect_x_overlap_ratio = reconcile_rect_x_overlap_ratio_runtime

_strip_caption_label_prefix = reconcile_make_strip_caption_label_prefix_runtime(
    clean_text=_clean_text,
)

_append_figure_caption_fragment = reconcile_make_append_figure_caption_fragment_runtime(
    clean_text=_clean_text,
...
_match_figure_for_caption_record = reconcile_make_match_figure_for_caption_record_runtime(
    record_bbox=_record_bbox,
    rect_x_overlap_ratio=_rect_x_overlap_ratio,
    figure_label_token=_figure_label_token,
)

_absorb_figure_caption_continuations = reconcile_make_absorb_figure_caption_continuations_runtime(
...
_page_one_front_matter_records = reconcile_make_page_one_front_matter_records_runtime(
    clean_text=_clean_text,
    normalize_title_key=normalize_title_key,
...
_decode_control_heading_label = reconcile_decode_control_heading_label_runtime

_normalize_decoded_heading_title = reconcile_make_normalize_decoded_heading_title_runtime(
    clean_text=_clean_text,
    clean_heading_title=clean_heading_title,
)

_split_embedded_heading_paragraph = reconcile_make_split_embedded_heading_paragraph_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
...
_looks_like_math_fragment = reconcile_make_looks_like_math_fragment_runtime(
...
_math_signal_count = reconcile_make_math_signal_count_runtime(
    math_token_re=MATH_TOKEN_RE,
)

_strong_operator_count = reconcile_strong_operator_count_runtime

_mathish_ratio = reconcile_make_mathish_ratio_binding_runtime(
    word_count=_word_count,
    math_signal_count=_math_signal_count,
)

_math_entry_semantic_policy = reconcile_math_entry_semantic_policy_binding_runtime

_math_entry_category = reconcile_math_entry_category_binding_runtime

_group_entry_items_are_graphic_only = reconcile_make_group_entry_items_are_graphic_only_binding_runtime(
    math_entry_semantic_policy=_math_entry_semantic_policy,
)

_math_entry_looks_like_prose = reconcile_make_math_entry_looks_like_prose_binding_runtime(
...
_should_demote_prose_math_entry_to_paragraph = reconcile_make_should_demote_prose_math_entry_to_paragraph_binding_runtime(
    normalize_paragraph_text=_normalize_paragraph_text,
    word_count=_word_count,
...
_should_demote_graphic_math_entry_to_paragraph = reconcile_make_should_demote_graphic_math_entry_to_paragraph_binding_runtime(
    should_demote_prose_math_entry_to_paragraph=_should_demote_prose_math_entry_to_paragraph,
)

_should_drop_display_math_artifact = reconcile_make_should_drop_display_math_artifact_binding_runtime(
...
_paragraph_block_from_graphic_math_entry = reconcile_make_paragraph_block_from_graphic_math_entry_binding_runtime(
    normalize_paragraph_text=_normalize_paragraph_text,
...
_inject_external_math_records = reconcile_make_inject_external_math_records_binding_runtime(
    clean_text=_clean_text,
...
_mathpix_hint_alignment_text = reconcile_make_mathpix_hint_alignment_text_runtime(
    clean_text=_clean_text,
    display_math_prose_cue_re=DISPLAY_MATH_PROSE_CUE_RE,
...
_mathpix_hint_tokens = reconcile_make_mathpix_hint_tokens_runtime(
    hint_token_re=MATHPIX_HINT_TOKEN_RE,
)

_mathpix_text_candidate_score = reconcile_make_mathpix_text_candidate_score_runtime(
...
_matching_mathpix_text_blocks = reconcile_make_matching_mathpix_text_blocks_runtime(
    record_union_bbox=_record_union_bbox,
    rect_x_overlap_ratio=_rect_x_overlap_ratio,
)

_mathpix_text_hint_candidate = reconcile_make_mathpix_text_hint_candidate_runtime(
...
_looks_like_truncated_prose_lead = reconcile_make_looks_like_truncated_prose_lead_runtime(
    clean_text=_clean_text,
    short_word_re=SHORT_WORD_RE,
    truncated_prose_lead_stopwords=TRUNCATED_PROSE_LEAD_STOPWORDS,
)

_mathpix_prose_lead_repair_candidate = reconcile_make_mathpix_prose_lead_repair_candidate_runtime(
    clean_text=_clean_text,
...
_is_mathpix_text_hint_better = reconcile_make_is_mathpix_text_hint_better_runtime(
    clean_text=_clean_text,
    word_count=_word_count,
    inline_tex_signal_count=_inline_tex_signal_count,
)
...
_looks_like_vertical_label_cloud = reconcile_make_looks_like_vertical_label_cloud_runtime(
    strong_operator_count=_strong_operator_count,
)

_looks_like_table_marker_cloud = reconcile_make_looks_like_table_marker_cloud_runtime(
    strong_operator_count=_strong_operator_count,
)

_looks_like_browser_ui_scrap = reconcile_make_looks_like_browser_ui_scrap_runtime(
    short_word_re=SHORT_WORD_RE,
)

_looks_like_quoted_identifier_fragment = reconcile_make_looks_like_quoted_identifier_fragment_runtime(
    short_word_re=SHORT_WORD_RE,
    quoted_identifier_fragment_re=QUOTED_IDENTIFIER_FRAGMENT_RE,
)

_looks_like_glyph_noise_cloud = reconcile_make_looks_like_glyph_noise_cloud_runtime(
    short_word_re=SHORT_WORD_RE,
)

_merge_math_fragment_records = reconcile_make_merge_math_fragment_records_runtime(
...
_looks_like_affiliation = reconcile_looks_like_affiliation_runtime

_normalize_author_line = reconcile_make_normalize_author_line_runtime(
    clean_text=_clean_text,
...
_looks_like_contact_name = reconcile_make_looks_like_contact_name_runtime(
    clean_text=_clean_text,
    name_token_re=NAME_TOKEN_RE,
)

_looks_like_front_matter_metadata = reconcile_make_looks_like_front_matter_metadata_runtime(
    clean_text=_clean_text,
...
_looks_like_author_line = reconcile_make_looks_like_author_line_runtime(
...
_looks_like_intro_marker = reconcile_make_looks_like_intro_marker_runtime(
    clean_text=_clean_text,
    normalize_title_key=normalize_title_key,
    intro_marker_re=INTRO_MARKER_RE,
)

_looks_like_body_section_marker = reconcile_make_looks_like_body_section_marker_runtime(
    clean_text=_clean_text,
    clean_heading_title=clean_heading_title,
...
_strip_trailing_abstract_boilerplate = reconcile_make_strip_trailing_abstract_boilerplate_runtime(
    clean_text=_clean_text,
    compact_text=compact_text,
...
_normalize_abstract_candidate_text = reconcile_make_normalize_abstract_candidate_text_runtime(
    clean_text=_clean_text,
...
_abstract_text_is_usable = reconcile_make_abstract_text_is_usable_runtime(
    abstract_quality_flags=abstract_quality_flags,
)

_looks_like_page_one_front_matter_tail = reconcile_make_looks_like_page_one_front_matter_tail_runtime(
    clean_text=_clean_text,
    looks_like_front_matter_metadata=_looks_like_front_matter_metadata,
...
_split_leading_front_matter_records = reconcile_make_split_leading_front_matter_records_runtime(
    clean_text=_clean_text,
    looks_like_intro_marker=_looks_like_intro_marker,
    looks_like_page_one_front_matter_tail=_looks_like_page_one_front_matter_tail,
)

_parse_authors = reconcile_make_parse_authors_runtime(
    clean_text=_clean_text,
    normalize_author_line=_normalize_author_line,
)

_is_title_page_metadata_record = reconcile_make_is_title_page_metadata_record_runtime(
    clean_text=_clean_text,
    preprint_marker_re=PREPRINT_MARKER_RE,
    looks_like_front_matter_metadata=_looks_like_front_matter_metadata,
...
_normalize_affiliation_line = reconcile_make_normalize_affiliation_line_runtime(
    clean_text=_clean_text,
    author_note_re=AUTHOR_NOTE_RE,
    compact_text=compact_text,
)

_looks_like_affiliation_continuation = reconcile_make_looks_like_affiliation_continuation_runtime(
    clean_text=_clean_text,
    looks_like_front_matter_metadata=_looks_like_front_matter_metadata,
    short_word_re=SHORT_WORD_RE,
)

_split_affiliation_fields = reconcile_make_split_affiliation_fields_runtime(
    normalize_affiliation_line=_normalize_affiliation_line,
)

_dedupe_authors = reconcile_make_dedupe_authors_binding_runtime(
    normalize_author_line=_normalize_author_line,
    normalize_title_key=normalize_title_key,
)

_filter_front_matter_authors = reconcile_make_filter_front_matter_authors_binding_runtime(
    normalize_author_line=_normalize_author_line,
    short_word_re=SHORT_WORD_RE,
    looks_like_affiliation=_looks_like_affiliation,
    looks_like_front_matter_metadata=_looks_like_front_matter_metadata,
...
_build_affiliations_for_authors = reconcile_make_build_affiliations_for_authors_binding_runtime(
    normalize_affiliation_line=_normalize_affiliation_line,
...
_missing_front_matter_author = partial(
    assemble_missing_front_matter_author,
    FRONT_MATTER_MISSING_PLACEHOLDER,
)

_missing_front_matter_affiliation = partial(
    assemble_missing_front_matter_affiliation,
    FRONT_MATTER_MISSING_PLACEHOLDER,
)


_strip_author_prefix_from_affiliation_line = reconcile_make_strip_author_prefix_from_affiliation_line_runtime(
    clean_text=_clean_text,
    normalize_author_line=_normalize_author_line,
)


_title_lookup_keys = partial(
    reconcile_title_lookup_keys_runtime,
    clean_text=_clean_text,
    normalize_title_key=normalize_title_key,
)

_parse_authors_from_citation_line = reconcile_make_parse_authors_from_citation_line_runtime(
    clean_text=_clean_text,
    normalize_title_key=normalize_title_key,
...
_matches_title_line = partial(
    reconcile_matches_title_line_runtime,
    clean_text=_clean_text,
    compact_text=compact_text,
    short_word_re=SHORT_WORD_RE,
    normalize_title_key=normalize_title_key,
...
_dedupe_text_lines = partial(
    reconcile_dedupe_text_lines_runtime,
    clean_text=_clean_text,
    normalize_title_key=normalize_title_key,
)

_clone_record_with_text = partial(
    reconcile_clone_record_with_text_runtime,
    clean_text=_clean_text,
)

_record_word_count = partial(
    reconcile_record_word_count_runtime,
    clean_text=_clean_text,
    short_word_re=SHORT_WORD_RE,
)

_record_width = partial(
    reconcile_record_width_runtime,
    block_source_spans=_block_source_spans,
)

_abstract_text_looks_like_metadata = partial(
    reconcile_abstract_text_looks_like_metadata_runtime,
    abstract_quality_flags=abstract_quality_flags,
)

_should_replace_front_matter_abstract = partial(
    reconcile_should_replace_front_matter_abstract_runtime,
    abstract_quality_flags=abstract_quality_flags,
)

_leading_abstract_text = partial(
    reconcile_leading_abstract_text_runtime,
    clean_text=_clean_text,
    looks_like_front_matter_metadata=_looks_like_front_matter_metadata,
...
_opening_abstract_candidate_records = partial(
    reconcile_opening_abstract_candidate_records_runtime,
    clean_text=_clean_text,
    abstract_lead_re=ABSTRACT_LEAD_RE,
...
_abstract_text_is_recoverable = partial(
    reconcile_abstract_text_is_recoverable_runtime,
    abstract_quality_flags=abstract_quality_flags,
)

_replace_front_matter_abstract_text = partial(
    reconcile_replace_front_matter_abstract_text_runtime,
    block_source_spans=_block_source_spans,
)

_first_root_indicates_missing_intro = partial(
    reconcile_first_root_indicates_missing_intro_runtime,
    clean_text=_clean_text,
    clean_heading_title=clean_heading_title,
    parse_heading_label=parse_heading_label,
    normalize_title_key=normalize_title_key,
...
_split_late_prelude_for_missing_intro = partial(
    reconcile_split_late_prelude_for_missing_intro_runtime,
    first_root_indicates_missing_intro=_first_root_indicates_missing_intro,
)

_make_reference_entry = reconcile_make_reference_entry_binding_runtime(
    clean_text=_clean_text,
...
_looks_like_reference_text = reconcile_make_looks_like_reference_text_binding_runtime(
    clean_text=_clean_text,
...
_is_reference_start = reconcile_make_is_reference_start_binding_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
...
_merge_reference_records = reconcile_make_merge_reference_records_binding_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
    is_reference_start=_is_reference_start,
)

_split_trailing_reference_records = reconcile_make_split_trailing_reference_records_binding_runtime(
    looks_like_reference_text=_looks_like_reference_text,
    merge_reference_records=_merge_reference_records,
)

_extract_reference_records_from_tail_section = reconcile_make_extract_reference_records_from_tail_section_binding_runtime(
    clean_text=_clean_text,
...
_reference_records_from_mathpix_layout = reconcile_make_reference_records_from_mathpix_layout_binding_runtime(
    mathpix_text_blocks_by_page=_mathpix_text_blocks_by_page,
    clean_text=_clean_text,
    normalize_title_key=normalize_title_key,
    layout_record=_layout_record,
...
_starts_like_sentence = reconcile_starts_like_sentence

_starts_like_paragraph_continuation = reconcile_make_starts_like_paragraph_continuation_binding_runtime(
    clean_text=_clean_text,
)

_starts_like_strong_paragraph_continuation = reconcile_make_starts_like_strong_paragraph_continuation_binding_runtime(
    clean_text=_clean_text,
)

_ends_like_short_lead_in = reconcile_make_ends_like_short_lead_in_binding_runtime(
    clean_text=_clean_text,
)

_ends_like_clause_lead_in = reconcile_make_ends_like_clause_lead_in_binding_runtime(
    clean_text=_clean_text,
)

_is_paragraph_like_record = reconcile_is_paragraph_like_record_runtime

_merge_anchor_spans = reconcile_make_merge_anchor_spans_binding_runtime(
    block_source_spans=_block_source_spans,
)

_looks_like_running_header_record = reconcile_make_looks_like_running_header_record_binding_runtime(
    clean_text=_clean_text,
...
_looks_like_table_body_debris = reconcile_make_looks_like_table_body_debris_binding_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
)

_suppress_embedded_table_headings = reconcile_make_suppress_embedded_table_headings_binding_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
...
_looks_like_same_page_column_continuation = reconcile_looks_like_same_page_column_continuation_runtime

_should_merge_paragraph_records = reconcile_make_should_merge_paragraph_records_binding_runtime(
    clean_text=_clean_text,
    short_word_re=SHORT_WORD_RE,
    block_source_spans=_block_source_spans,
...
_list_item_marker = reconcile_make_list_item_marker_binding_runtime(
    clean_text=_clean_text,
)

_split_code_lines = assemble_split_code_lines

_looks_like_real_code_record = reconcile_make_looks_like_real_code_record_binding_runtime(
    clean_text=_clean_text,
)

_rect_intersection_area = reconcile_rect_intersection_area_binding_runtime

_rect_area = reconcile_rect_area_binding_runtime

_match_external_math_entry = reconcile_make_match_external_math_entry_binding_runtime(
    block_source_spans=_block_source_spans,
    clean_text=_clean_text,
)

_merge_native_and_external_layout = orchestrate_merge_native_and_external_layout

_is_figure_debris = reconcile_make_is_figure_debris_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
...
_is_short_ocr_fragment = reconcile_make_is_short_ocr_fragment_runtime(
    clean_text=_clean_text,
    block_source_spans=_block_source_spans,
...
def _make_reconcile_runtime_deps() -> ReconcileRuntimeDeps:
    return reconcile_make_reconcile_runtime_deps_runtime(
        loaders=reconcile_make_reconcile_loader_deps_runtime(
        ...
        bindings=reconcile_make_reconcile_binding_deps_runtime(
            text_deps=reconcile_make_reconcile_binding_text_deps_runtime(
            ...
            math_deps=reconcile_make_reconcile_binding_math_deps_runtime(
            ...
            front_matter_deps=reconcile_make_reconcile_binding_front_matter_deps_runtime(
            ...
            block_builder_deps=reconcile_make_reconcile_binding_block_builder_deps_runtime(
            ...
            layout_heading_deps=reconcile_make_reconcile_binding_layout_heading_deps_runtime(
        ...
        assembly=reconcile_make_reconcile_assembly_deps_runtime(
...
def reconcile_paper_state(
    ...
    *,
    ...
    return reconcile_run_reconcile_pipeline_runtime(
        ...
        deps=_make_reconcile_runtime_deps(),
    )
