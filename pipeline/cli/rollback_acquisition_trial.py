...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Rollback a promoted acquisition trial bundle using its previous-live backup."
    )
...
def run_rollback_trial_cli(
    args: argparse.Namespace,
    *,
    rollback_trial_fn: Callable[..., dict[str, Any]] = rollback_acquisition_trial,
) -> int:
    summary = rollback_trial_fn(
        args.paper_id,
...
def main() -> int:
    return run_rollback_trial_cli(parse_args())
